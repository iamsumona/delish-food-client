...
import { getAuth, GithubAuthProvider, GoogleAuthProvider, signInWithPopup, signOut, createUserWithEmailAndPassword, signInWithEmailAndPassword } from "firebase/auth";
                ...
                <div className="m-auto w-96">
                    ...
                    {userInfo ? <div className=''>
                        ...
                        <div>
                            ...
                            <button onClick={handleGithubSignOut} className='btn btn-success'>Github Sign Out</button>
                        </div>
                    }
